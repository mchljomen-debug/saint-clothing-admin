                            ...
                            return (
                                <div key={product._id} className={`grid grid-cols-[2fr_.9fr_.85fr_repeat(6,.38fr)_.5fr_.5fr_.75fr_.62fr] items-center gap-1 border-b border-[#ecece6] px-4 py-4 ${index % 2 === 0 ? "bg-white" : "bg-[#fcfcfb]"}`}>
                                    ...
                                    <div className="text-center">
                                        <span className="inline-flex rounded-[5px] bg-[#f3f3f1] border border-black/10 px-1.5 py-1 text-[7px] font-black uppercase">{normalizeCategory(product.category) || "None"}</span>
                                    </div>
                                    ...
                                    <div className="text-center">
                                        <span className={`inline-flex rounded-[5px] border px-1.5 py-1.5 text-[7px] font-black uppercase ${getInventoryStatusClass(status)}`}>{status}</span>
                                    </div>
